...
These bonuses stack with existing armor enhancement bonuses to a maximum of +5, or they can be used to add any of the following armor special abilities: dastard, ghost touch, fortification (heavy, light, or medium), invulnerability, spell resistance (13, 15, 17, or 19).
Adding these special abilities consumes an amount of bonus equal to the special ability’s base price modifier. In addition, the iron tyrant can grant his armor the unrighteous special ability at the cost of a +4 bonus. These special abilities are added to any special abilities the armor already has, but duplicate abilities do not stack.
